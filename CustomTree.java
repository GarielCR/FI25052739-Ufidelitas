...
public class CustomTree {
    ...
    private TreeNode insert(TreeNode node, double tf, String word) {
        ...
        // Actualizar
        // Insertamos el nodo según su TF. Si el TF es menor va a la izquierda, si es mayor va a la derecha. Si es igual, solo agregamos la palabra a la pila del nodo.
        if (node == null) {
